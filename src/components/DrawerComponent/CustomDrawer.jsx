    ...
    <ScrollView contentContainerStyle={styles.contentContainer}>
      <SafeAreaView forceInset={{ top: "always", horizontal: "never" }}>
        <ScrollView>
          ...
          <Animated.View
            style={[
              { marginTop: 10, transform: [{ translateX }], letterSpacing: 3 },
            ]}
          >
            <DrawerItem
              label={"@ Now"}
            ...
            <DrawerItem
              label={"Provider"}
              labelStyle={{ letterSpacing: 1, fontSize: 16 }}
              onPress={() => handleMenuItem("ProviderPage")}
            />

<DrawerItem
              label={"ProviderSeeSchedule"}
              labelStyle={{ letterSpacing: 1, fontSize: 16 }}
              onPress={() => handleMenuItem("ProviderSeeSchedule")}
            />

<DrawerItem
              label={"ProviderEditProfile"}
              labelStyle={{ letterSpacing: 1, fontSize: 16 }}
              onPress={() => handleMenuItem("ProviderEditProfile")}
            />
